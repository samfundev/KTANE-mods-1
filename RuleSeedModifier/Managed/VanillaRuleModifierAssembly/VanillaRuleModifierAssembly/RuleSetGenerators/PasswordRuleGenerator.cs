...
namespace VanillaRuleModifierAssembly.RuleSetGenerators
{
    ...
    {
        private static readonly PasswordRuleSetGenerator RuleSetGenerator = new PasswordRuleSetGenerator();

        protected override AbstractRuleSet CreateRules(bool useDefault)
        {
            return RuleSetGenerator.GenerateRuleSet(1);
        }
        ...
        public static Dictionary<string, string> LocalizedAlphabet = new Dictionary<string, string>()
        {
            {"en", "abcdefghijklmnopqrstuvwxyz"}
        };

        public static Dictionary<string, List<string>> LocalizedPossibleWords = new Dictionary<string, List<string>>
        {
            {
                "en", new List<string>
                {
