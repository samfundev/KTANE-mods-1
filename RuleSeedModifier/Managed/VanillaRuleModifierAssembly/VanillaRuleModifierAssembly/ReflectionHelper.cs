...
public static class ReflectionHelper
{
	...
	public static Type[] FindTypes(string fullName)
	{
		return AppDomain.CurrentDomain.GetAssemblies().SelectMany(a => a.GetSafeTypes()).Where(t => t.FullName != null && t.FullName.EndsWith(fullName)).ToArray();
	}
