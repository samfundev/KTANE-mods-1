...
public class VanillaRuleModifier : MonoBehaviour
{
    ...
    private VanillaRuleModifierProperties publicProperties;
    ...
    private void Start ()
    {
        ...
        publicProperties = infoObject.AddComponent<VanillaRuleModifierProperties>();
        publicProperties.VanillaRuleModifer = this;
