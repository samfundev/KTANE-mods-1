...
namespace Assets.Scripts.RuleGenerator
{
    public static class MorseAMazeRuleGenerator
    {
		...
		private static List<string> PossibleWords = new List<string>
		{
	    ...
	    private static List<string> ExtendedWords = new List<string>
		{
			...
			"begun", "being", "bells", "belly", "belts", "bench", "bible", "bikes", "bills", "birds", "birth", "bitch", "black", "blade", "blame", "bland", "blank", "blast",
			...
			"green", "greet", "grief", "grill", "grips", "groin", "groom", "gross", "group", "grown", "grows", "guard", "guess", "guest", "guide", "guild", "guilt", "guise",
			...
			"irony", "issue", "items", "ivory", "japan", "jeans", "jelly", "jesus", "jewel", "joins", "joint", "joker", "jokes", "jolly", "joule", "joust", "judge", "juice",
			...
			"mould", "mound", "mount", "mouse", "mouth", "moved", "moves", "movie", "muddy", "mummy", "mused", "music", "myths", "nails", "naive", "naked", "named", "names",
			"nanny", "nasty", "naval", "nazis", "necks", "needs", "nerve", "nests", "newer", "newly", "nicer", "niche", "niece", "night", "ninth", "noble", "nodes", "noise",
			...
			"raise", "rally", "range", "ranks", "raped", "rapid", "rated", "rates", "ratio", "razor", "reach", "react", "reads", "ready", "realm", "rebel", "refer", "reign",
			...
			"hazard", "headed", "header", "health", "hearth", "hearts", "heater", "heaved", "heaven", "hedges", "height", "helmet", "helped", "helper", "heroes", "heroin", "hidden", "hiding", "higher",
			"highly", "hinder", "hissed", "hockey", "holder", "homage", "honour", "hooker", "hoping", "horror", "horses", "hostel", "hotels", "hounds", "housed", "houses", "hugely", "hugged", "humans",
			"humour", "hunger", "hunter", "hurdle", "ideals", "ignore", "images", "impact", "import", "impose", "incest", "inches", "income", "indeed", "induce", "infant", "influx", "inform", "injury",
			...
			"vendor", "venues", "verses", "versus", "vessel", "victim", "videos", "viewed", "viewer", "vigour", "villas", "violin", "virgin", "virtue", "vision", "visits", "voices", "volume", "voters",
