...
public class FakeBombInfo : MonoBehaviour
{
    ...
    public bool ForceUnicorn = false;

    [Header("Modded Widgets")]
    ...
    public class EncryptedIndicatorWidget : Widget
    {
        ...
        public EncryptedIndicatorWidget(bool enableColors = false, string unicornLabel = null, string unicornColor = null)
        {
            ...
            if (enableColors)
            {
                ...
                {
                    color = !@on ? PossibleColors[0] : PossibleColors[Random.Range(1, PossibleColors.Length)];
                }
            }
    ...
    Widget GetRandomWidget()
    {
        ...
        switch (choice)
        {
            ...
            default:
                return new MultipleWidget(EnableTwoFactorMultipleWidgets, MultipleWidgetsTwoFactoryExpiry);
        }
    }
